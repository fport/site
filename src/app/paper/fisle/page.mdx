...
Same shape as the rest of my work — written up in more detail in my <Link href="/paper/stack" className="underline">stack post</Link>, kept small enough for a side project to maintain.
