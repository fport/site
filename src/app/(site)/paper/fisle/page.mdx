...
Same shape as the rest of my work — every piece of it, and why it earned its place, is laid out in my <Link href="/garden/stack" className="underline">stack garden</Link>. Kept small enough for a side project to maintain.
