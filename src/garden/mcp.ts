...
export const mcpGarden: Garden = {
  ...
  notes: [
    ...
    },
    {
      ...
      summary: 'N models, M tools, every pair a bespoke protocol. MCP collapses it to N+M.',
      kind: 'schema',
      status: 'evergreen',
      updated: UPDATED,
      cluster: 'why',
    ...
    /* ------------------------------------------------------- primitives -- */
    {
      ...
      summary: 'Three things a server exposes — and the difference is who decides to use them.',
      kind: 'schema',
      status: 'evergreen',
      updated: UPDATED,
      cluster: 'primitives',
    ...
    },
    {
      ...
      summary: 'MCP does not replace function calling — it answers where the tool list came from.',
      kind: 'note',
      status: 'growing',
      updated: UPDATED,
      cluster: 'building',
