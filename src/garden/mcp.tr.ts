...
export const mcpGardenTr: GardenTranslation = {
  title: 'MCP Bahçesi',
  tagline: "Model Context Protocol — N×M problemi, mimari, primitive'ler ve 2026 stateless spec'i.",
  description:
  ...
  notes: {
    ...
    'what-mcp-is': {
      title: 'MCP nedir',
      summary: "Bir modeli dış sistemlere bağlamanın standart yolu. LLM'ler için tool discovery.",
      Content: WhatMcpIsTr,
    },
    'the-nxm-problem': {
      title: 'N×M problemi',
      summary: "N model, M tool, her çift ısmarlama bir protokol. MCP bunu N+M'ye indiriyor.",
    ...
    transports: {
      ...
      summary: "Yerel için stdio, uzak için Streamable HTTP. Eski HTTP+SSE transport'u deprecated.",
    ...
    'server-primitives': {
      ...
      summary: "Bir server'ın dışa açtığı üç şey — fark, onları kullanmaya kimin karar verdiğinde.",
    ...
    'tool-design': {
      ...
      summary: 'Model bir isim, bir açıklama ve bir schema görür. Kalite orada yaşar.',
    ...
    'mcp-vs-function-calling': {
      ...
      summary: "MCP function calling'in yerini almaz — tool listesinin nereden geldiğini cevaplar.",
    ...
    'attack-surface': {
      ...
      summary: 'Tool poisoning, indirect prompt injection, confused deputy, supply chain.',
