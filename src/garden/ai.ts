...
export const aiGarden: Garden = {
  ...
  notes: [
    /* ------------------------------------------------------------ start -- */
    {
      slug: 'roadmap',
      title: 'Roadmap',
      summary: 'The reading order: problem, cheapest fix, cheap wins, expensive wins, measurement.',
      kind: 'schema',
      status: 'evergreen',
      updated: UPDATED,
      cluster: 'start',
    ...
    /* ---------------------------------------------------- table stakes -- */
    {
      ...
      summary: 'Split on headings, keep 10–15% overlap, prepend a context line to every chunk.',
      kind: 'note',
      status: 'growing',
      updated: UPDATED,
    ...
    /* --------------------------------------------------------- finetune -- */
    {
      ...
      summary: 'Yes for form, no for facts. The order: prompt, RAG, fine-tune, distill.',
      kind: 'schema',
      status: 'growing',
      updated: UPDATED,
      cluster: 'finetune',
    ...
    },
    {
      ...
      summary: 'Full SFT, LoRA, QLoRA, DPO, GRPO, distillation — and when each one is the answer.',
      kind: 'note',
      status: 'growing',
      updated: UPDATED,
      cluster: 'finetune',
