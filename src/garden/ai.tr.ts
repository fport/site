...
export const aiGardenTr: GardenTranslation = {
  ...
  notes: {
    ...
    roadmap: {
      title: "Yol haritası",
      summary:
        "Okuma sırası: problem, en ucuz çözüm, ucuz kazanımlar, pahalı kazanımlar, ölçüm.",
      Content: RoadmapTr,
    },
    ...
    "rag-vs-fine-tune": {
      ...
      summary:
        "RAG bilgi için, fine-tuning biçim için. Bir karar tablosu ve bir karar ağacı.",
    ...
    "vanilla-rag-pipeline": {
      ...
      summary:
        "İki ayrı hat: offline index kurulumu ve her istekte çalışan sorgu yolu.",
      Content: VanillaRagPipelineTr,
    },
    "baseline-stack": {
      title: "Referans baseline stack",
      summary:
        "Express + LangChain + Chroma + Ollama. Her ölçümün kıyaslandığı sıfır noktası.",
    ...
    "chunking-open-question": {
      ...
      summary:
        "Retrieval birimi embedding birimine göre nerede durmalı — hâlâ çözülmedi.",
    ...
    "vanilla-vs-agentic": {
      ...
      summary:
        "Latency, token, karmaşıklık, doğruluk, hata yüzeyi. Karar bu takastan ibaret.",
    ...
    "context-budget": {
      ...
      summary:
        "Önce kararlı prefix, en sona değişken kısım — yoksa iki kere ödersin.",
    ...
    "when-to-fine-tune": {
      ...
      summary:
        "Biçim için evet, olgular için hayır. Sıra: prompt, RAG, fine-tune, distill.",
